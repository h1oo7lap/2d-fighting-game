...
public class PlayerHealth4 : MonoBehaviour
{
    ...
    private bool isShieldActive = false; // Shield from Skill K
    ...
    {
        // Check shield first (from Skill K)
        if (isShieldActive)
        {
            Debug.Log(gameObject.name + " miễn nhiễm damage (Shield)!");
            return;
        }
    ...
    void DisablePlayerComponents()
    {
        ...
        PlayerController4 controller = GetComponent<PlayerController4>();
        if (controller != null)
    ...
    // ===== SKILL K - SHIELD METHODS =====
    public void SetInvincible(bool invincible)
    {
        isShieldActive = invincible;
    }
    ...
    {
        return isInvincible || isShieldActive;
    }
